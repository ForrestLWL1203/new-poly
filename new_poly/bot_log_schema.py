...
def _entry_analysis(decision: StrategyDecision, result: ExecutionResult | None = None) -> dict[str, Any]:
    ...
    row = {
        ...
        "entry_reference_model_prob": _compact(decision.reference_model_prob),
...
def _exit_analysis(decision: StrategyDecision, result: ExecutionResult | None = None) -> dict[str, Any]:
    ...
    row = {
        ...
        "exit_binance_model_prob": _compact(decision.binance_model_prob),
        "exit_reference_model_prob": _compact(decision.reference_model_prob),
...
def _position_log(position: PositionSnapshot | None, *, compact: bool) -> dict[str, Any] | None:
    ...
    return {
        ...
        "entry_reference_model_prob": _compact(position.entry_reference_model_prob),
